...
module.exports = {
  name: "bansave",
  description: "Banish a user from the guild without deleting previous messages",
  usage: "bansave <@user/user ID> [reason]",
  example: "bansave @zhue raiding the server",
  category: "Moderation",
  timeout: 3000,
  aliases: ["banishsave", "bsave"],
